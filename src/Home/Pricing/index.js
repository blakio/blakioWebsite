...
const Pricing = () => {
  ...
  return (<div id="pricingSection" className="flex">
    ...
    <p className="pricingDescription"><span className="green big">$4000</span> / yr</p>

    <p className="title">HOW IT WORKS</p>
    <p className="pricingDescription">Add your first dashboard feature for a one time charge from <span className="green big">$0</span></p>
    <br />
    <br />
